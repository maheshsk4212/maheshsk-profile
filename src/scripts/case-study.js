...
function renderProjectContent() {
    ...
    // ── Hero Title & Subtitle ─────────────────────────────────────────────────
    const heroVisualHTML = project.visualStyle ? `<div class="project-hero-visual" style="background: ${project.visualStyle}; height: 400px; border-radius: 20px; margin-bottom: 40px;"></div>` : '';
    
    document.getElementById('project-title').insertAdjacentHTML('beforebegin', heroVisualHTML);
    ...
    sectionsHTML += `
    <section class="project-section behance-cta-section fade-in">
        <div class="behance-cta-card">
            <div class="behance-cta-content">
                <h3 class="behance-cta-title">Explore More Work</h3>
                <p class="behance-cta-text">For more UI designs and detailed case studies, please refer to my Behance profile.</p>
            </div>
